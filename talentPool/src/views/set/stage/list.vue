<template>
  ...
  <div class="wrapper">
        <div class="content-wrap">
            ...
            <el-select v-model="listState.state" placeholder="请选择阶段" @change="changeProcessState">
                <el-option label="启用的阶段" :value="1"></el-option>
                <el-option label="停用的阶段" :value="0"></el-option>
            </el-select>
...
export default {
  ...
  methods: {
		...
		async flowNodeList(){
			const {
				data: res
			} = await this.$http.flowNodeList({params:this.listState})
