<template>
  ...
  <div class="wrapper">
        <div class="content-wrap">
            ...
            <el-select v-model="listState.state" placeholder="请选择状态" @change="changeProcessState">
                <el-option label="启用的状态" :value="1"></el-option>
                <el-option label="停用的状态" :value="0"></el-option>
            </el-select>
...
export default {
  ...
  methods: {
		...
		async flowStateList(){
			const {
				data: res
			} = await this.$http.flowStateList({params:this.listState})
